...
export default function Bills() {
  ...
  const { data: bills, insert, update, remove } = useTable('bills', { orderBy: 'due_day' })
  const { data: categories } = useTable('categories', { orderBy: 'sort_order' })
  const { data: payments, insert: insertPayment, update: updatePayment, refetch: refetchPayments } = useTable('bill_payments')
