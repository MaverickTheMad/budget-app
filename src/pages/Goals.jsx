...
export default function Goals() {
  const { data: goals, insert, update, remove } = useTable('goals', { orderBy: 'sort_order', filters: [{ col: 'archived', op: 'eq', val: false }] })
  const { data: contributions, insert: insertContribution, refetch: refetchContributions } = useTable('goal_contributions', { orderBy: 'date', ascending: false })
